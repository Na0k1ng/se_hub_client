    ...
    <v-sheet :color="baseColor" width="100%">
      <v-list class="pl-14" flat>
        ...
        <v-list-itm-group :color="naviItmColor.home">
          <v-list-item v-if="loginState" to="/" @click="toHome" :active-class="naviFont" :ripple="false">
            <v-list-item-icon>
          ...
          <v-list-item to="/explore" :active-class="naviFont" :ripple="false">
            <v-list-item-icon>
          ...
          <v-list-item v-if="loginState" to="/bpManagement" :active-class="naviFont" :ripple="false">
            <v-list-item-icon>
          ...
          <v-list-item v-if="loginState" to="/messages" :active-class="naviFont" :ripple="false">
            <v-list-item-icon>
          ...
          <v-list-item v-if="loginState" @click="toProfile()" to="" :active-class="naviFont" :ripple="false">
            <v-list-item-icon>
              <v-icon large :color="iconColor">mdi-account</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
